...
- **3w 2d** (98%) — [Phase 04: Visualization](../workdown-items/phase-04-visualization.md)
  - **5d 16h** (25%) — [Renderers](../workdown-items/renderers.md)
  ...
  - **2d** (9%) — [Polish & dogfood](../workdown-items/polish.md)
    - **12h** (25%) — [`when:` — derive a field value by first matching condition](../workdown-items/conditional-field-value.md)
    - **12h** (25%) — [Comparisons, equality and booleans in the expression grammar](../workdown-items/expression-predicates.md)
    - **8h** (17%) — [Resolve the current date at evaluation time, reproducibly](../workdown-items/evaluation-time-now.md)
    - **8h** (17%) — [Explicit `in` operator; `=` becomes always-literal](../workdown-items/explicit-in-operator.md)
