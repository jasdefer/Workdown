...
- **3w 2d 5h** (96%) — [Phase 04: Visualization](../workdown-items/phase-04-visualization.md)
  - **5d 16h** (24%) — [Renderers](../workdown-items/renderers.md)
  ...
  - **4d** (17%) — [Author and edit views from the UI](../workdown-items/view-authoring.md)
  ...
  - **3d 8h** (14%) — [Interactive UI (workdown serve)](../workdown-items/server.md)
  ...
  - **3d** (13%) — [View & item presentation](../workdown-items/view-presentation.md)
  ...
  - **2d 8h** (10%) — [Foundation](../workdown-items/foundation.md)
  ...
  - **2d 5h** (10%) — [Polish & dogfood](../workdown-items/polish.md)
    - **12h** (23%) — [`when:` — derive a field value by first matching condition](../workdown-items/conditional-field-value.md)
    - **12h** (23%) — [Comparisons, equality and booleans in the expression grammar](../workdown-items/expression-predicates.md)
    - **8h** (15%) — [Resolve the current date at evaluation time, reproducibly](../workdown-items/evaluation-time-now.md)
    - **8h** (15%) — [Explicit `in` operator; `=` becomes always-literal](../workdown-items/explicit-in-operator.md)
    - **4h** (8%) — [Validate resource references and render resource pickers](../workdown-items/resource-option-lists.md)
    - **4h** (8%) — [Validate where-clause operands against the field's value set](../workdown-items/where-clause-value-validation.md)
    - **3h** (6%) — [Optional --install-hooks for pre-commit render](../workdown-items/init-install-hooks.md)
    - **2h** (4%) — [README: document the visualization workflow](../workdown-items/readme-visualization-update.md)
...
- **13h** (2%) — [Miscellaneous improvements](../workdown-items/misc-work.md)
  - **4h** (31%) — [Collapse the metric-row duplicates of the generic view checks](../workdown-items/views-check-metric-row-dedup.md)
  - **3h** (23%) — [One clock read per invocation, writes included](../workdown-items/evaluation-date-single-read.md)
  - **3h** (23%) — [Integer precision and NaN in comparison evaluation](../workdown-items/expression-comparison-corner-cases.md)
  - **3h** (23%) — [Move value coercion out of the store to break the parser↔store cycle](../workdown-items/value-coercion-layering.md)
