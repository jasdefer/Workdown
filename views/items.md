...
| [ci-test-run-completeness](../workdown-items/ci-test-run-completeness.md) | done | [testing-strategy](../workdown-items/testing-strategy.md) |  |
...
| [cli-binary-tests](../workdown-items/cli-binary-tests.md) | done | [testing-strategy](../workdown-items/testing-strategy.md) |  |
...
| [compute-type-support-mismatch](../workdown-items/compute-type-support-mismatch.md) | done | [misc-work](../workdown-items/misc-work.md) |  |
...
| [config-hot-reload](../workdown-items/config-hot-reload.md) | removed | [misc-work](../workdown-items/misc-work.md) |  |
...
| [effort-timer](../workdown-items/effort-timer.md) | done | [time-tracking](../workdown-items/time-tracking.md) | [effort-field-config](../workdown-items/effort-field-config.md), [duration-delta-absent-value](../workdown-items/duration-delta-absent-value.md), [confirm-dialog](../workdown-items/confirm-dialog.md) |
...
| [over-default-single-definition](../workdown-items/over-default-single-definition.md) | done | [maintenance-review-2026-08](../workdown-items/maintenance-review-2026-08.md) |  |
...
| [recording-dot-extraction](../workdown-items/recording-dot-extraction.md) | to_do | [misc-work](../workdown-items/misc-work.md) |  |
| [relocate-operations-tests](../workdown-items/relocate-operations-tests.md) | done | [testing-strategy](../workdown-items/testing-strategy.md) | [cli-binary-tests](../workdown-items/cli-binary-tests.md) |
...
| [render-flow-doc](../workdown-items/render-flow-doc.md) | done | [maintenance-review-2026-08](../workdown-items/maintenance-review-2026-08.md) |  |
...
| [schema-definition-api](../workdown-items/schema-definition-api.md) | to_do | [schema-editor-web](../workdown-items/schema-editor-web.md) |  |
...
| [schema-editor-web-design](../workdown-items/schema-editor-web-design.md) | done | [schema-editor-web](../workdown-items/schema-editor-web.md) |  |
| [schema-expressions](../workdown-items/schema-expressions.md) | in_progress |  |  |
| [schema-field-editor-numeric](../workdown-items/schema-field-editor-numeric.md) | to_do | [schema-editor-web](../workdown-items/schema-editor-web.md) | [schema-field-editor-shell](../workdown-items/schema-field-editor-shell.md) |
| [schema-field-editor-relation](../workdown-items/schema-field-editor-relation.md) | to_do | [schema-editor-web](../workdown-items/schema-editor-web.md) | [schema-field-editor-shell](../workdown-items/schema-field-editor-shell.md) |
| [schema-field-editor-shell](../workdown-items/schema-field-editor-shell.md) | to_do | [schema-editor-web](../workdown-items/schema-editor-web.md) | [schema-page-read-view](../workdown-items/schema-page-read-view.md), [schema-field-write-backend](../workdown-items/schema-field-write-backend.md) |
| [schema-field-editor-text](../workdown-items/schema-field-editor-text.md) | to_do | [schema-editor-web](../workdown-items/schema-editor-web.md) | [schema-field-editor-shell](../workdown-items/schema-field-editor-shell.md) |
| [schema-field-editor-values](../workdown-items/schema-field-editor-values.md) | to_do | [schema-editor-web](../workdown-items/schema-editor-web.md) | [schema-field-editor-shell](../workdown-items/schema-field-editor-shell.md) |
...
| [schema-page-read-view](../workdown-items/schema-page-read-view.md) | to_do | [schema-editor-web](../workdown-items/schema-editor-web.md) | [schema-definition-api](../workdown-items/schema-definition-api.md) |
...
| [schema-rules-editor](../workdown-items/schema-rules-editor.md) | on_hold | [schema-editor-web](../workdown-items/schema-editor-web.md) | [schema-page-read-view](../workdown-items/schema-page-read-view.md), [schema-field-write-backend](../workdown-items/schema-field-write-backend.md) |
| [schema-string-to-choice](../workdown-items/schema-string-to-choice.md) | on_hold | [schema-editor-web](../workdown-items/schema-editor-web.md) | [schema-field-type-change](../workdown-items/schema-field-type-change.md), [schema-field-editor-values](../workdown-items/schema-field-editor-values.md) |
...
| [test-audit](../workdown-items/test-audit.md) | done | [testing-strategy](../workdown-items/testing-strategy.md) | [relocate-operations-tests](../workdown-items/relocate-operations-tests.md) |
| [testing-guide](../workdown-items/testing-guide.md) | done | [testing-strategy](../workdown-items/testing-strategy.md) |  |
| [testing-strategy](../workdown-items/testing-strategy.md) | done |  |  |
...
| [views-check-metric-row-dedup](../workdown-items/views-check-metric-row-dedup.md) | done | [misc-work](../workdown-items/misc-work.md) |  |
